...
export default function Form2() {
  ...
  return (
    ...
    <input className="newTicket__input" {...register("apellidos", { required: true, minLength: 3})} />
    </div>
  <div className='newTicket__input-container'>
  ...
  <input type="number" className="newTicket__input" {...register("telefono", { required: true, minLength: 3})} />
  </div>
  <div className='newTicket__input-container'>
